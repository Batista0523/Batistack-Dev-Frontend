        ...
        <GlowCard featured style={{ padding: "clamp(32px, 4vw, 48px)", marginBottom: "24px" }}>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              >
                <img
                  src="/brand/mac-studio-stack.png"
                  alt="Mac mini AI infrastructure hardware installed on site"
      ...
      <Reveal>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "28px", flexWrap: "wrap", alignItems: "center" }}>
            <Link href="/how-it-works" data-cursor="cta" style={linkStyle}>
              How It Works →
            </Link>
            <Link href="/ai-agents" data-cursor="cta" style={linkStyle}>
              Meet the Agents →
            </Link>
          </div>
        </div>
