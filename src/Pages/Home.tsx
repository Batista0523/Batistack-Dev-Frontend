        ...
        <Container fluid>
          <Row className="align-items-center">
            <Col md={6} className="text-center text-md-start px-5">
              ...
              >
                We build high-impact websites and apps tailored to your business
                — from idea to execution with speed, style, and security.
              </motion.p>
      ...
      <div className="py-5" style={{ backgroundColor: "#e9ecef" }}>
        <Container>
          ...
          >
            ...
            <p className="text-muted fs-5">
              A simple, effective approach to building modern digital products.
            </p>
          </motion.div>
        ...
        <Container>
          ...
          >
            ...
            <p className="fs-5 mb-4">
              Your vision deserves more than just code — it needs care, clarity,
