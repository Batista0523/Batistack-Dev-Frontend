    ...
    <Row className="align-items-center gy-4">
      ...
      <Col md={7}>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Elisaul leads Batistack with engineering precision and deep business understanding. 
          He helps clients turn ideas into digital products that are smart, scalable, and impactful.
        </motion.p>
      </Col>
    </Row>
  </Container>
