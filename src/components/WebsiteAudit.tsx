  ...
  <Container>
    <Row className="justify-content-center text-center">
      <Col lg={8}>
        ...
        >
          AI Website <span className="text-primary">Analyzer</span>
        </motion.h1>
        ...
        >
          Instantly audit your website’s speed, SEO, accessibility, and best practices.
          Let <strong>Batistack AI</strong> reveal what’s slowing you down — and how to fix it.
        </motion.p>
      </Col>
    </Row>
  </Container>
